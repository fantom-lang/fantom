...
//////////////////////////////////////////////////////////////////////////
  ...
  Void testOrigin()
  {
    verifyEq(`http://foo/a?q`.origin, "http://foo")
    verifyEq(`https://foo:443/x`.origin, "https://foo")
    verifyEq(`http://foo:8080/a/b`.origin, "http://foo:8080")
    verifyEq(`http://Foo/a`.origin, "http://foo")
    verifyEq(`http://FOO:80/`.origin, "http://foo")
    verifyEq(`/a/b`.origin, null)
    verifyEq(`foo`.origin, null)
  }
