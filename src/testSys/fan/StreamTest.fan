...
//////////////////////////////////////////////////////////////////////////
  ...
  static Void readBinary(Test test, InStream in, Bool testSize := true)
  {
    ...
    test.verify(in.readF4.approx(-128e22f))
in.readF4    //test.verifyEq(in.readF4, Float.nan)
in.readF4    //test.verifyEq(in.readF4, Float.posInf)
in.readF4    //test.verifyEq(in.readF4, Float.negInf)
...
in.readF8    //test.verifyEq(in.readF8, Float.nan)
in.readF8    //test.verifyEq(in.readF8, Float.posInf)
in.readF8    //test.verifyEq(in.readF8, Float.negInf)
