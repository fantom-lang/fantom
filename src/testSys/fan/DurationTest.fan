...
//////////////////////////////////////////////////////////////////////////
  ...
  Void testLocale()
  {
    verifyLocale(0ns, "0ns")
    verifyLocale(1ns, "1ns")
    verifyLocale(3ns, "3ns")
    verifyLocale(999ns, "999ns")
    verifyLocale(3000ns, "0.003ms")
    verifyLocale(78000ns, "0.078ms")
    verifyLocale(800_000ns, "0.8ms")
    verifyLocale(803_900ns, "0.803ms")
    verifyLocale(1_123_000ns, "1.123ms")
    verifyLocale(1ms, "1.0ms")
    verifyLocale(2ms, "2ms")
    verifyLocale(1999ms, "1999ms")
    verifyLocale(2004ms, "2sec")
    verifyLocale(6sec+88ms, "6sec")
    verifyLocale(5min+2sec, "5min 2sec")
    verifyLocale(10hr + 5min+2sec, "10hr 5min 2sec")
    verifyLocale(1day + 10hr + 5min+2sec, "1day 10hr 5min 2sec")
    verifyLocale(3day + 55sec, "3days 55sec")
    verifyLocale(5min, "5min")
    verifyLocale(1day+2min, "1day 2min")
  }

  Void verifyLocale(Duration dur, Str expected)
  {
    verifyEq(dur.toLocale, expected)
    if (dur != 0ns) verifyEq(dur.negate.toLocale, "-"+expected)
  }
