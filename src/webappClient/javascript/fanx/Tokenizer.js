 ...
 */
var fanx_Tokenizer = Class.extend(
{
...
var fanx_Undo = Class.extend(
{
  $ctor: function(t, v, l) { this.type = t; this.val = v; this.line = l; },
  reset: function(t) { t.reset(this.type, this.val, this.line); }
});