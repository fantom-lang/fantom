...
internal const class NilCrypto : Crypto
{
  ...
  override Jwt decodeJwt(Str encoded, Key key, Duration clockDrift := 60sec) { throw unsupported }
  override Str encodeJwt(Str:Obj header, Str:Obj claims, Key key) { throw unsupported }
