...
**
** FontMetrics are stored for unicode chars from 0x20 to 0xff for a
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** Lookup metrics for font by key
  static FontMetrics? find(Font f)
  {
    registry[toKey(f.style, f.weight, f.name)]
  }

  ** Table keyed by "<style> <weight> <name>"
  const static Str:FontMetrics registry
  static
  {
    acc := Str:FontMetrics[:] { ordered = true }
    try
    {
  ...
  ** Used by static initializer
  private static Void register(Str:FontMetrics acc, FontMetrics m)
  {
    acc[m.key] = m
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** Return best match for normalized font
  ...
  private static FontMetrics? toNormalize(FontStyle style, FontWeight weight, Str name)
  {
