...
//////////////////////////////////////////////////////////////////////////
  ...
  public void select(fan.fwt.Tree self, Obj node)
  {
  ...
  public void setExpanded(fan.fwt.Tree self, Obj node, Bool expanded)
  {
    Tree c = (Tree)this.control;
  ...
  public void show(fan.fwt.Tree self, Obj node)
  {
    Tree c = (Tree)this.control;
...
//////////////////////////////////////////////////////////////////////////
  ...
  private void setData(Obj node, TreeItem item)
  {
    TreeModel model = model();
    if (model == null) return;
