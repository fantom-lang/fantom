...
//////////////////////////////////////////////////////////////////////////
  ...
  Void testFind()
  {
    ...
    verifyEq(doc.findNext("Th", 0, false), 20)
    verifyEq(doc.findNext("Th", 0, true), 6)
    verifyEq(doc.findNext("TH", 0, false), null)
    verifyEq(doc.findNext("TH", 0, true), 6)
    verifyEq(doc.findNext("THING", 0, false), null)
    verifyEq(doc.findNext("THING", 0, true), 20)
    ...
    verifyEq(doc.findNext("Foo", 0, false), null)
    ...
    verifyEq(doc.findPrev("FOO", 99, false), null)
