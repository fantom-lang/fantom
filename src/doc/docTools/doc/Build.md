...
[Fantom scripts](Fan#running-scripts) which subclass from [build::BuildScript].
...
Note: see [Setup] to configure your environment to run
...
[HelloWorld](docIntro::HelloWorld#fantom-pod) for a simpler example.
