...
See [HelloWorld](docIntro::HelloWorld#fantom-script) for an example of
how run a script file.

Also see [unix setup](Setup#executable-scripts) and [windows setup](Setup#executable-scripts-1)
...
See [HelloWorld](docIntro::HelloWorld#fantom-pod) for an example of how
