...
[Once methods](docLang::Methods#once-methods) only compute their result the
...
# Constructors
One thing different about Fantom is that [constructors](docLang::Methods#constructors)
are named methods:
...
[inferred](docLang::Closures#closure-type-inference) from its context:
