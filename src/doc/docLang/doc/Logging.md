...
All logs default to level `info` (see [setup](#log-setup) to change default levels).
...
Handlers must be an instance of an [immutable Func](Functions#immutable-functions) (they
