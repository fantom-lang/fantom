...
defining a new type.  We use inheritance for two purposes:
  - [contract specialization](#contract-specialization)
  - [implementation reuse](#implementation-reuse)
...
[contract specialization](#contract-specialization).  Private and internal
...
There are three mechanisms of override:
  1. Method overrides Method (see [virtual methods](Methods#virtual-methods))
  2. Field overrides Field (see [virtual fields](Fields#virtual-fields))
  3. Field overrides Method (see [overriding a method](Fields#overriding-a-method))
...
covariance support:
  ...
  3. Field overrides Method: supported - [details](Fields#overriding-a-method)
