...
with the JS compiler. It is highly recommended to spend some time looking at the
JavaScript source code in [sys](https://github.com/fantom-lang/fantom/tree/master/src/sys/js/fan)
...
`src/compilerJs/fan/ast/JsNode.fan`.
