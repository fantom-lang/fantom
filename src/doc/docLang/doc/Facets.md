...
are implied to be [const classes](Classes#const-classes) which means all their
...
inheritance works on any type (class or mixin) in the
[inheritance hierarchy](sys::Type.inheritance).
