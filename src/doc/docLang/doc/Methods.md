...
[safe invokes](Expressions#safe-invoke).
...
You can also use the [shorthand syntax](#construction-calls):
...
They are typically used to initialize [static fields](Fields#static-fields).
...
within a [class](Classes#abstract-classes), then the containing class must
also be `abstract`.
