...
namespace Fan.Sys
{
  ...
  //////////////////////////////////////////////////////////////////////////
    ...
    public static Long toInt(Long self) { return self; }

    public static Double toFloat(Long self) { return Double.valueOf(self.longValue()); }

    public static Decimal toDecimal(Long self) { return Decimal.make(new decimal(self.longValue())); }
